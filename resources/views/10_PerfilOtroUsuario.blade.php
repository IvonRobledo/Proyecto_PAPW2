        ...
        <div class=" container">
            <div class="row">
                <div class="col-lg-3 text-left">
                    <img class="img-circle special-img foto-perfil" src="/imagenesPerfil/{{ $data->nombreFotoP }}"/>
                </div>
                <div class="col-lg-6 col-md-6  text-center">
                    <h3 class="nombreUsuario">{{ $data->name }}</h3>
                     @php
       $id_usuario = $data->id;
