...
<link href="css/bootstrap.css" rel="stylesheet">
  ...
  <div class="middle">
	...
	<div id= "divRegistro" style="min-width: 250px; min-height: 50px;">
		...
		<h2 class="textosR">¡Lee y escribe reseñas!</h2>
		{!!Form::open(['route'=>'IniciarSesion.store', 'method'=>'POST'])!!}
		<input type="hidden" name="_token" value="{{ csrf_token() }}">
		<!--{{ Form::open(array('url' => '/IniciarSesion.store', 'method'=>'post')) }}-->
  
			<span class="glyphicon glyphicon-user" style="padding-right: 5px;"></span>
			<input class="aux registro" type="text" placeholder="Correo*" name="usuario"/>
			...
			<a"><button id="ingresar" type="submit" class="boton page-scroll btn btn-default btn-registrate">Ingresar</button></a>
		
        {{ Form::close() }}

		<br><label class="labelreg">¿Aún no tienes una cuenta? <a class="link-rl" href="Registro">Regístrate</a>.</label>
         </center> 
